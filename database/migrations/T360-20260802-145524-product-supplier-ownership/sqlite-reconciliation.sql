-- Reconciliation gate setelah sqlite-expand.sql dan sqlite-backfill.sql.
-- Gate release hanya lulus bila semua query issue menghasilkan nol baris.
...
SELECT 'product_unresolved' AS "issue", p."id", p."sku" AS "businessKey", NULL AS "candidateCount"
...
SELECT 'supplier_unresolved' AS "issue", s."id", s."code" AS "businessKey", NULL AS "candidateCount"
