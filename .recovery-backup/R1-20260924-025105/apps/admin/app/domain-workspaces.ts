...
export const ADMIN_DOMAIN_WORKSPACES: AdminDomainWorkspace[] = [
  ...
  { workspaceKey: 'settings', views:[
    { key: 'features', roles: ['SUPER_ADMIN','OWNER','ADMIN'], label: 'Fitur Runtime', title: 'Runtime features', description: 'Module catalog dan feature flags untuk company aktif.', Icon:Settings2 },
    { key: 'users', roles: ['SUPER_ADMIN','OWNER','ADMIN'], permissionPrefixes: ['user','role'], label: 'User & Role', title: 'Users, roles & branch access', description: 'User lifecycle, role assignment, protected accounts, dan branch access.', Icon:UserCog },
