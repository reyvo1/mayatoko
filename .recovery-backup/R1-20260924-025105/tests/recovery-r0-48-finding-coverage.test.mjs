...
const r0 = JSON.parse(read('work-items/active/T360-20260924-020700-recovery-r0-truth-reset.json'));
...
test('R0 is active governance and F12R4 is blocked behind recovery', () => {
  assert.equal(r0.phase, 'VERIFICATION');
