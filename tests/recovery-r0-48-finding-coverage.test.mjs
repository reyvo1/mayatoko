...
const r1 = JSON.parse(read('work-items/active/T360-20260924-022400-recovery-r1-tenant-access-control-plane.json'));
...
test('R0 is closed, R1 is active, and F12R4 remains blocked behind recovery', () => {
  assert.equal(r0.phase, 'CLOSED');
  assert.equal(r0.wave, 'W0');
  assert.equal(r1.phase, 'VERIFICATION');
